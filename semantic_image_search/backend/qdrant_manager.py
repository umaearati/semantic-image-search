...
if __name__ == "__main__":
    ...
    # curl http://127.0.0.1:6333/collections/semantic-image-search
    # “Scalar quantization helps reduce memory usage by compressing embeddings, so we can store more data and search faster without losing much accuracy.”